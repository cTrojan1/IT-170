# -*- coding: utf-8 -*-
"""
Created on Mon Oct  9 11:29:02 2023

@author: camtr
"""
from p2Lib1 import sumList, meanList, minMaxList, stdevList
...
print("The summation of this population is", "%.2f" % sumList(dataList))
print("The mean of this population is", "%.2f" % meanList(dataList, sumList(dataList)))
print("The min and max of this population is", minMaxList(dataList))
print("The standard deviation of this population is", "%.2f" % stdevList(dataList))