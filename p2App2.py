# -*- coding: utf-8 -*-
"""
Created on Wed Oct 11 15:38:45 2023

@author: camtr
"""
from p2Lib2 import sampling
from p2Lib1 import meanList
...
while x != 5:
        print("The mean of 5 samples with replacement is: ", "%.2f" % sampling(dataList, 5, True))
        x = x+1
...
while x != 5:
        print("The mean of 10 samples with replacement is: ", "%.2f" % sampling(dataList, 10, True))
        x = x+1
...
while x != 5: 
        print("The mean of 30 samples with replacement is: ", "%.2f" % sampling(dataList, 30, True))
        x = x+1
...
while x != 5:
        print("The mean of 5 samples without replacement is: ", "%.2f" % sampling(dataList,  5, False))
        x = x+1
...
while x != 5:    
        print("The mean of 10 samples without replacement is: ", "%.2f" % sampling(dataList,  10, False))
        x = x+1
...
while x != 5:
        print("The mean of 30 samples without replacement is: ", "%.2f" % sampling(dataList, 30, False))
        x = x+1
